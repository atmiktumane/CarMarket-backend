package com.java.CarMarket_backend.utility;
...
public class Data {
    public static String otpEmailBody(String otp, String username){
        return "<!DOCTYPE html>"
                ...
                + "<head>"
                + "<meta charset='UTF-8' />"
                + "<title>Your CarMarket OTP Code</title>"
                + "</head>"
                ...
                + "<tr>"
                + "<td style='padding: 20px; text-align: center; background-color: #a092cb; border-top-left-radius: 8px; border-top-right-radius: 8px;'>"
                + "<h2 style='margin: 0; color: #333333;'>CarMarket</h2>"
                + "</td>"
                + "</tr>"
                + "<tr>"
                ...
                + "<p style='color: #555555;'>Thanks,<br />CarMarket Team</p>"
                + "</td>"
                + "</tr>"
                + "<tr>"
                ...
                + "© 2025 CarMarket. All rights reserved."
                + "</td>"
                + "</tr>"
                + "</table>"
                + "</body>"
